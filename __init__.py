...
from space.bodies.exoplanets import all_cold_zone_planets, all_confirmed_planets, all_exoplanet_around_a_stars, \
...
class SpaceIsAwesome(OVOSSkill):
    ...
    @intent_handler(
        IntentBuilder("ProbeNamesIntent").require("names").require("probes"))
    ...
    @intent_handler(
        IntentBuilder("ProbeNumberIntent").require("how_many").require(
            "probes"))
    ...
    @intent_handler('available.topics.intent')
    ...
    @intent_handler(
        IntentBuilder("StarsExoplanetsIntent").require("how_many").require(
            "exoplanets").require("orbiting").require("star"))
    ...
    @intent_handler(
        IntentBuilder("HotZoneExoplanetsIntent").require("how_many").require(
            "exoplanets").require("hot_zone"))
    def handle_number_of_hot_zone_planets(self, message):
        if self.hot_zone_planets_cache is None:
            self.hot_zone_planets_cache = all_hot_zone_planets()["exoplanets"]
    ...
    @intent_handler(
        IntentBuilder("ColdZoneExoplanetsIntent").require("how_many").require(
            "exoplanets").require("cold_zone"))
    ...
    @intent_handler(
        IntentBuilder("WarmZoneExoplanetsIntent").require("how_many").require(
            "exoplanets").require("warm_zone"))
    ...
    @intent_handler(
        IntentBuilder("NeptunianExoplanetsIntent").require("how_many").require(
            "exoplanets").require("neptunian"))
    ...
    @intent_handler(
        IntentBuilder("JovianExoplanetsIntent").require("how_many").require(
            "exoplanets").require("jovian"))
    def handle_number_of_jovian_planets(self, message):
        if self.jovian_planets_cache is None:
            self.jovian_planets_cache = all_jovian_planets()["exoplanets"]
    ...
    @intent_handler(
        IntentBuilder("TerranExoplanetsIntent").require("how_many").require(
            "exoplanets").require("terran"))
    def handle_number_of_terran_planets(self, message):
        if self.terran_planets_cache is None:
            self.terran_planets_cache = all_terran_planets()["exoplanets"]
    ...
    @intent_handler(
        IntentBuilder("SuperterranExoplanetsIntent").require(
            "how_many").optionally("exoplanets").require("superterran"))
    def handle_number_of_superterran_planets(self, message):
        if self.terran_planets_cache is None:
            self.terran_planets_cache = all_superterran_planets()["exoplanets"]
        number = len(self.terran_planets_cache)
        self.speak_dialog("planet.number", {
            "number": number,
            "type": "superterran"
    ...
    @intent_handler(
        IntentBuilder("SubterranExoplanetsIntent").require("how_many").op(
            "exoplanets").require("subterran"))
    def handle_number_of_subterran_planets(self, message):
        if self.terran_planets_cache is None:
            self.terran_planets_cache = all_subterran_planets()["exoplanets"]
        number = len(self.terran_planets_cache)
        self.speak_dialog("planet.number", {
            "number": number,
            "type": "subterran"
    ...
    @intent_handler(
        IntentBuilder("ConfirmedExoplanetsIntent").require("how_many").require(
            "exoplanets").require("confirmed"))
    ...
    @intent_handler(
        IntentBuilder("UnconfirmedExoplanetsIntent").require(
            "how_many").require("exoplanets").require("unconfirmed"))
    ...
    @intent_handler('astronaut.names.intent')
    @intent_handler(
        IntentBuilder("AstronautIntent").require("names").require(
    ...
    @intent_handler('astronaut.number.intent')
    ...
    @intent_handler('cool.thing.intent')
